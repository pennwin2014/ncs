...
<form name="form1" method="post" action="/pronline/MsgL">
      ...
      <td width="100%"  valign=middle align=center height="40" bgcolor="#DEE8FA" class="ttt"> 
        ...
        <tr>
            <td width="51%" height="29">&nbsp;
              <input type="hidden" name="FunName" value="ncsDebugClientOnline">
      ...
      <td width="100%" align=center  valign=top bgcolor="#DEE8FA"> 
        <table id="DataTable" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
          <tr> 
            ...
            <input type="button" name="b1" value="全选" class="anniu_1"  onClick="allChecked()">            </td>
            <td width="98" bgcolor="#6382BD" class="bord2"><font color="#FFFFFF">序号</font>
            <div align="center"></div></td>
            <td width="104" bgcolor="#6382BD" class="bord2" >url</td>
            <td width="104" bgcolor="#6382BD" class="bord2" >
<div align="center"><font color="#FFFFFF">ftype</font></div></td>
            <td width="89" bgcolor="#6382BD" class="bord2" >
<div align="center"><font color="#FFFFFF">urlid</font></div></td>
            <td width="109" bgcolor="#6382BD" class="bord2" >cond</td>
            <td width="93" bgcolor="#6382BD" class="bord2" >flags</td>
          </tr>
          <!-- [#SLPB#] -->
          <tr onMouseOver="mouseovertr2(this)" onMouseOut="mouseouttr2(this)"> 
            ...
            <td width="98" height="16" class="bord1"><a href="/pronline/Msg?FunName@ncsDebugSynMonSet&gtype@[#gtype#]&ntype@[#ntype#]&start@[#start#]&len@[#len#]&sum@[#sum#]">&nbsp;[#num#]</a></td>
            <td width="104" class="bord1">[#url#]</td>
            <td width="104" height="16" class="bord1">[#ftype#]</td>
            <td width="89" height="16" class="bord1">&nbsp;[#urlid#] </td>
            <td width="109" class="bord1">[#cond#]</td>
            <td width="93" class="bord1">[#flags#]</td>
          </tr>
          <!-- [#SLPE#] -->
          <!-- [#SLPB#] -->
          <tr id=[#snum#]> 
            <td width="46" height="16" class="bord1">&nbsp; </td>
            <td width="98" height="16" class="bord1">&nbsp;</td>
            <td width="104" class="bord1">&nbsp;</td>
            <td width="104" height="16" class="bord1">&nbsp;</td>
            <td width="89" height="16" class="bord1">&nbsp; </td>
            <td width="109" class="bord1">&nbsp;</td>
            <td width="93" class="bord1">&nbsp;</td>
          </tr>
          <!-- [#SLPE#] -->
        </table>
