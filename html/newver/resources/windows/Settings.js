...
Ext.define('MyDesktop.Settings', {
    ...
    initComponent: function () {
        ...
        me.buttons = [
            { text: '确认', handler: me.onOK, scope: me },
    ...
    onSelect: function (tree, record) {
        ...
        if (record.data.img) {
            me.selected = '/newver/resources/windows/wallpapers/' + record.data.img;
        } else {
    ...
    setInitialSelection: function () {
        ...
        if (s) {
            var path = '/newver/resources/windows/Wallpaper/' + this.getTextOfWallpaper(s);
