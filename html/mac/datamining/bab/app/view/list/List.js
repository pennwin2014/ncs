        ...
        this.columns = [
        {
          header: '编辑',
           ...
           handler: function(grid, rowIndex, colIndex, actionItem, event, record, row) {
            ...
            {header: '产生记录数', dataIndex: 'reportcount',align:'center', flex:1,sortable: false},
            {header: '最新报表产生时间', dataIndex: 'reporttime', align: 'center', flex: 1, sortable: false ,
            renderer: function (value, metaData, record) {
             
                    if (value == 0) { return '<font color="red">暂无</font>' }
                    else { return '<font color="green">' + getLocalTime(value).Format("yyyy/MM/dd hh:mm:ss") + '</font>' }
