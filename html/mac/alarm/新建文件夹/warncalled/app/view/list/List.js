    ...
    this.columns = [
     {
        ...
        {header: '姓名',dataIndex: 'name',width:120, sortable: true},
		 {header: '所属部门',dataIndex: 'department',width:120, sortable: false},
          {header: '联系人电话',dataIndex: 'phone', width:160,sortable: true},
		{header: '联系邮箱',dataIndex: 'email',  width:80},
         {header: '最新接警时间',dataIndex: 'calledtime',   width:80},
	     {header: '待处理接警数',dataIndex: 'dealcount',   width:80},
	    {header: '接警总数',dataIndex: 'calledcount',width:120, sortable: false},
	     {
          header: '告警处理',
            xtype: 'actioncolumn',
            dataIndex: 'userid',
