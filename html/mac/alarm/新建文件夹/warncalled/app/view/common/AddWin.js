  	        ...
  	        {xtype:'hidden',id:'sid',name:'sid',value:''},
            {
			   ...
			   { xtype: 'fieldcontainer',layout: 'hbox',
                ...
                {xtype:'textfield',fieldLabel: '联系邮箱',labelWidth: 90,emptyText:'输入邮箱',width:280,name: 'email',afterLabelTextTpl:required}   
			   		...
			   		{ xtype: 'fieldcontainer',layout: 'hbox',
                items:[
                {xtype:'textfield',fieldLabel: '最新接警时间',labelWidth: 90,emptyText: '',width:280,name: 'calledtime',afterLabelTextTpl:required}   
			         ]
			         },{ xtype: 'fieldcontainer',layout: 'hbox',
                items:[
                ,{xtype:'textfield',fieldLabel: '待处理接警数',labelWidth: 90,emptyText: '',width:280,name: 'dealcount'}   
			         ]
			         },{ xtype: 'fieldcontainer',layout: 'hbox',
                items:[
                ,{xtype:'textfield',fieldLabel: '&nbsp;接警总数',labelWidth: 90,emptyText: '',width:280,name: 'calledcount'}
			         ]
			         }, */
			   /*
			         { xtype: 'fieldcontainer',layout: 'hbox',
                items:[
                ,{xtype:'textfield',fieldLabel: 'AP名称',labelWidth: 70,emptyText: 'AP显示名',width:210,name: 'gwid',afterLabelTextTpl:required}
