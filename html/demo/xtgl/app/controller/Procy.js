 ...
 xtglqxgl:function(){
         ...
         collapsible: false,
				items: [{
						...
						name:'rightgroup',
						columns: 3,
						items:[{boxLabel: '信息查询',checked:false},
							   {boxLabel: '布控告警',checked:false},
							   {boxLabel: '数据挖掘',checked:false},
							   {boxLabel: '业务配置',checked:false},
							   {boxLabel: '系统配置',checked:false},
							   {boxLabel: '我的账号',checked:false}
							  ]
					}]
				},
				/*{					
						...
						items:[{boxLabel: '信息查询',checked:false},
							  ...
							  handler: function(){
								...
								if(checkrole.substr(0,1)==',') checkrole = checkrole.substr(1);
								 Ext.MessageBox.alert('提示', '您的角色名是：'+servicecode+'权限是'+checkrole);
