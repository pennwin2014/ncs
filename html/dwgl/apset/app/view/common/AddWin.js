...
//      queryMode:'remote',
  	...
  	this.items = [
  	{
  	     xtype: 'form',frame:true,width:700, bodyPadding:5,
  	        items: [
			{xtype:'hidden',id:'oldApname',name:'oldApname',value:''},
             ...
             width:220, 
                ...
                ,{xtype:'textfield',fieldLabel: '&nbsp;安装地址',labelWidth: 70,emptyText: '',width:320,name: 'address'}
			         ...
			         ,
			          { xtype: 'fieldcontainer',layout: 'hbox',
                items:[
                {xtype:'textfield',fieldLabel: '经度',labelWidth: 70,emptyText: '',width:210,name: 'longitude',afterLabelTextTpl:required}   
                ,{xtype:'textfield',fieldLabel: '&nbsp;纬度',labelWidth: 70,emptyText: '',width:210,name: 'latitude',afterLabelTextTpl:required}
                ,facCombo
			         ]
			         }
			         ,
			         { xtype: 'fieldcontainer',layout: 'hbox',
                items:[
                {xtype:'textfield',fieldLabel: 'SSID',labelWidth: 70,emptyText: '',width:210,name: 'ssid'}   
	...
	if(this.field2&&this.field2!=''){ 
		tform.getForm().findField('oldApname').setValue(this.field2);
	}
