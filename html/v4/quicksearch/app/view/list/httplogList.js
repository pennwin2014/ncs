Ext.define('quickResarch.view.list.httplogList' ,{
//  extend: 'Ext.panel.Panel',
extend: 'Ext.form.Panel',
  alias : 'widget.httplog',
//  region:'center',
// height: 390,
  initComponent: function() {
  	var twidth=parent.Ext.getCmp('layout_center').getWidth()-250;
       ...
       '<td width="60" class="bord2" > 网址类别</td>',
       '<td width="250" class="bord2" > 网址</td>',
       '<td width="110" class="bord2" > 标题</td>',
       ...
       '</tr>',
        ...
        '<td   class="bord1">{urltype}</td>',
        '<td   class="bord1">{url}</td>',
         '<td   class="bord1">{title}</td>',
    ...
    this.tbar = Ext.create('Ext.PagingToolbar',{
     ...
     items:[
         ...
         '-', 
     	 {xtype:'label', html:'<span>网站访问日志</span>', style : 'margin-top:10px;margin-left:70px'}
     	]
    }
    );
   this.items = [
