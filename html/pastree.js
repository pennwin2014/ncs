var statenn
function goto999(t){
  window.open(t+"&scroll@"+document.body.scrollTop+"&opennum@"+statenn,"sbpm_right","")
  //parent.sbpm_right.location.href=t
  //sbpm_right.location.href=t+"&scroll@"+document.body.scrollTop+"&opennum@"+statenn
}

function ff(t1,t2){
  if(t2 != "") {
    clickedFolder = indexOfEntries[t2] 
...
{ 
  if (this.hreference) 
  { 
    doc.write("<a href='" + this.hreference + "' target=\"sbpm_right\"' ") 
    if (browserVersion > 0) 
     doc.write("onClick=javascript:clickOnFolder("+this.id+",'"+this.hreference+"')") 
    doc.write(">") 
  } 
//  else 
//   doc.write("<a>") 
//    doc.write("<a href=javascript:clickOnFolder("+this.id+",'"+this.hreference+"')>")   
} 
 
 
function clickOnFolder(folderId,ty) 
{ 
   parent.parent.sbpm_right.location.href=ty
} 
...
{ 
  ...
  doc.write("<tr><td>") 
  doc.write(leftSide) 
  doc.write("<a href=javascript:goto999('"+this.link+"') >")
  doc.write("<img id='itemIcon"+this.id+"' ") 
  doc.write("src='"+this.iconSrc+"' border=0 >") 
  doc.write("</a>") 
  doc.write("</td><td valign=middle nowrap>") 
  if (USETEXTLINKS) 
    doc.write("<a href=javascript:goto999('"+this.link+"')>" + this.desc + "</a>") 
  else 
    doc.write(this.desc) 
  doc.write("</table>") 
...
{ 
//fullLink = "" 
// fullLink = "'"+hreference+"' target=\"sbpm_right\"" 
//parent.sbpm_right.location.herf=hreference
 fullLink =hreference 
