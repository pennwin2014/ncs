...
function Chrome ()
{
	...
	this.winMinBut_Norm.src = "images/ChromeClose_Down.gif";
	this.winMinBut_Over = new Image ();
	this.winMinBut_Over.src = "images/ChromeClose_Down.gif";
	this.winMinBut_Down = new Image ();
	this.winMinBut_Down.src = "images/ChromeClose_Down.gif";
	
	this.winMaxBut_Norm = new Image ();
	this.winMaxBut_Norm.src = "images/ChromeClose_Down.gif";
	this.winMaxBut_Over = new Image ();
	this.winMaxBut_Over.src = "images/ChromeClose_Down.gif";
	this.winMaxBut_Down = new Image ();
	this.winMaxBut_Down.src = "images/ChromeClose_Down.gif";
	...
	if (this.windowControls != windowControls_None)
		{
			...
			if ((this.windowControls & windowControls_Minimize) && (this.windowControls & windowControls_Maximize)) html += "<img border=\"0\" width=\"1\" height=\"1\" src=\"/images/ChromeClose_Norm.gif\">";
