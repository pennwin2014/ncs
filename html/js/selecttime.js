...
Calendar.prototype.show = function() {
    ...
    // Setup the page...
    this.wwrite("<html>");
    this.wwrite("<head><title>时间--选择</title>");
    ...
    this.wwrite("<body bgcolor='#DEE8FA'" + 
        "link=\"" + this.gLinkColor + "\" " + 
        "vlink=\"" + this.gLinkColor + "\" " +
        "alink=\"" + this.gLinkColor + "\" " +
        "text=\"" + this.gTextColor + "\" topmargin='2'>");
    this.wwriteA("<FONT color='#7392C6' FACE='" + fontface + "' ><B>");
    ...
    this.wwrite("<TABLE WIDTH='100%' BORDER=1 bordercolor='#4B74B6' CELLSPACING=0 CELLPADDING=0 BGCOLOR='#7392C6'><TR><TD ALIGN=center>");
    this.wwrite("<A HREF=\"" +
