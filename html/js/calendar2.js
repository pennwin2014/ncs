...
function fSetDate(iYear, iMonth, iDay){
  ...
  if ((iYear == 0) && (iMonth == 0) && (iDay == 0)){
  	...
  	if(gdCtrl.tagName == "INPUT"){
  		if(gdCtrl.name=='edate')
  	  	gdCtrl.value = iYear+"-"+iMonth+"-"+iDay+" 23:59:59";
  	  else
  	  	gdCtrl.value = iYear+"-"+iMonth+"-"+iDay+" 00:00:00";
  	}else{
...
write("<table border='0' bgcolor='#cccccc' width='100%' onblur='VicPopCal.style.visibility = hidden;'>");
write("<TR>");
