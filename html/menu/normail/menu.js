	...
	for(var i in document.all)
	{
		if (document.all[i].tagName == 'BODY')
		{
			MenuBodyRef = document.all[i]
				...
				stringx += "<tr><td  width=100% height=170px ><iframe width=100% height=170 frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n";
}else if(x==3){
				stringx += "<tr><td  width=100% height=120px ><iframe width=100% height=120 frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n";
}else if(x==4){
				...
				stringx += "<tr><td  width=100% height=210px ><iframe width=156% height=210 frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n";
}else if(x==6){
				stringx += "<tr><td  width=100% height=140px ><iframe width=100% height=140 frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n";
}else if(x==7){
...
pmenu6=new Menu('系统(M)','','self');
pmenu6.addItem(new MenuItem('监控','javascript:goto("jksjb.htm")','self',false,'监控'));

pmenu7=new Menu('历史记录','','self');
pmenu7.addItem(new MenuItem('历史记录','javascript:goto("jksjb.htm")','self',false,'监控'));
