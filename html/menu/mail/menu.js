	...
	for(var i in document.all)
	{
		if (document.all[i].tagName == 'BODY')
		{
			MenuBodyRef = document.all[i]
				...
				stringx += "<tr><td  width=100% height=76px ><iframe width=100% height=51 frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n";
}else if(x==2){
				...
				stringx += "<tr><td  width=100% height=51px ><iframe width=100% height=51 frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n";
}else if(x==4){
				stringx += "<tr><td  width=100% height=59px ><iframe width=100% height=59 frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n";
}else if(x==5){
				stringx += "<tr><td  width=100% height=133px ><iframe width=100% height=133 frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n";
}else if(x==6){
				stringx += "<tr><td  width=100% height=203px ><iframe width=100% height=203 frameborder=0 scrolling=no src='/layermenu"+x+"-"+i+".htm'></iframe></td></tr>\n";
}else if(x==7){
